    ...
    <div className="bg-white dark:bg-[#1F2933] rounded-3xl border-2 border-rose-400 dark:border-rose-800 p-6 sm:p-8 text-center space-y-6 shadow-md transition-colors">
      ...
      <div className="space-y-2">
        <h2 className="text-2xl font-black text-rose-700 dark:text-rose-400 flex items-center justify-center gap-2">
          <span>⚠ {t.invalidImageTitle || "Invalid Image"}</span>
        </h2>

        <p className="text-sm font-semibold text-[#263238] dark:text-[#F5F7FA] max-w-md mx-auto leading-relaxed">
          {t.invalidImageMsg || "This image does not appear to contain a suitable onion image. Please capture a clear photo of a real onion."}
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 max-w-md mx-auto pt-2">
        ...
        >
          ...
          <span>{t.captureAgain || "Retake Photo"}</span>
        </button>
        ...
        >
          ...
          <span>{t.uploadAnother || "Upload Another Image"}</span>
        </button>
      </div>

      <div className="text-[11px] text-[#607D8B] dark:text-[#B8C2CC] font-bold">
        {t.noFakeScoreNotice || "No quality score, grade, or price is generated for non-onion images."}
      </div>
