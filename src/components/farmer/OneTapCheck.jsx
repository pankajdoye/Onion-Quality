...
import { Camera, Upload, Sparkles, CheckCircle2, Image as ImageIcon, ShieldAlert } from 'lucide-react';
  ...
  return (
    <div className="bg-white dark:bg-[#1F2933] rounded-3xl border border-slate-200 dark:border-[#374151] p-6 sm:p-8 shadow-sm text-center space-y-6 transition-colors">
      ...
      <div>
        ...
        <p className="text-xs text-[#607D8B] dark:text-[#B8C2CC] font-semibold mt-1">Select a photo for instant computer vision grading</p>
      </div>
      ...
      <div className="pt-4 border-t border-slate-100 dark:border-[#374151] space-y-2">
        <div className="flex items-center justify-between text-xs font-extrabold text-[#263238] dark:text-[#F5F7FA]">
          <span className="flex items-center gap-1">
            <ShieldAlert className="w-4 h-4 text-[#F59E0B]" /> Verification Testing Presets:
          </span>
          <span className="text-[10px] text-[#607D8B] dark:text-[#B8C2CC] font-semibold">Click to test Stage 1 Gate</span>
        </div>
